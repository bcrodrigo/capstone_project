...
def load_data(dataset_selection,dataset_options):
    ...
    if dataset_selection == dataset_options[0]:
        ...
        # DeepFire Dataset
        filename = 'prediction_files/predictions_DeepFire.csv'
        img_class = ('non-fire','fire')
        path_dataset = '02_forest_fire_dataset_128x128/'

    elif dataset_selection == dataset_options[1]:

        # WildFire Dataset
        filename = 'prediction_files/predictions_Wildfire Dataset.csv'
        img_class = ('non-fire','fire')
        path_dataset = '03_the_wildfire_dataset_128x128/'

    elif dataset_selection == dataset_options[2]:

        # Danger Dataset - cats and dogs
        filename = 'prediction_files/predictions_DANGER.csv'
        img_class = ('cats','dogs')
        path_dataset = 'danger_dataset_128x128/'
